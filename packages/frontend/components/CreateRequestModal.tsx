          ...
          {isSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1.5">Weights define how the contract scores proposals. Must sum to 100.</p>
              </div>
