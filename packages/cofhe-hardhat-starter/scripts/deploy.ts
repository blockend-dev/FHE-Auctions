/**
 * Standalone deploy script using viem — no hardhat runtime needed.
 *
 * Prerequisites:
 *   1. npm run compile  (or: npx hardhat compile)
 *   2. Create .env with: PRIVATE_KEY=0x<your_key>
 *   3. node --import tsx/esm scripts/deploy.ts
 *
 * After deploy, update packages/frontend/.env.local with the printed addresses.
 */
